...
export function Navbar() {
  return (
    <>
      {/* Left Side */}
      <div className="w-screen h-[10vh] max-h-[80px] bg-[#1e1e1e] border-b border-white/10 px-8 flex items-center justify-between">
        <Link
          to="/"
          className="flex items-center gap-2 text-white text-semibold text-xl"
        >
